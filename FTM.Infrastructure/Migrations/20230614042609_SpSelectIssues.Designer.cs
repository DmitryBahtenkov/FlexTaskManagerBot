...
namespace FTM.Infrastructure.Migrations
{
    ...
    [Migration("20230614042609_SpSelectIssues")]
    partial class SpSelectIssues
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FTM.Domain.Models.IssueModel.Issue", b =>
                {
                    ...
                    b.Property<RetrySettings>("RetrySettings")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("FTM.Infrastructure.DataAccess.Context.IssuesForDaily", b =>
                {
                    b.Property<int[]>("IssueIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.ToTable("SpIssuesForDailies");

                    b.ToFunction("select_today_issues");
                });
